...
;layui.define([ "laytpl", "layer" ], function(e) {
	...
	i.loading = function(e) {
		...
		var a = this;
		layui.router();return e = r.views + e + r.engine, t("#" + s).children(".layadmin-loading").remove(), i.loading(a.container), t.ajax({
				url : e,
				type : "get",
				dataType : "html",
				data : {
				...
				success : function(e) {
					...
					delete a.then
					), a.parse(e), i.removeLoad(), a.done && (a.done(s),
					delete a.done
					)
				},
				error : function(e) {
