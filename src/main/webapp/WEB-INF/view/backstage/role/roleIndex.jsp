	 ...
	 <div class="layui-fluid">   
	    <div class="layui-card">
	      <div class="layui-form layui-card-header layuiadmin-card-header-auto">
	        <div class="layui-form-item" style="width:500px;margin:auto">
			    ...
			    <div class="layui-inline">
		            <button class="layui-btn layuiadmin-btn-useradmin" lay-submit lay-filter="LAY-user-adminrole-search">
	  ...
	  <script>
		 layui.config({
		    ...
		    //搜索角色
		    form.on('submit(LAY-user-adminrole-search)', function(data){
		          ...
		          ,yes: function(index, layero){
		            ...
		            iframeWindow.layui.form.on('submit(LAY-user-role-submit)', function(data){
		              ...
		              $.ajax({
			                type: "POST",//方法类型
			                dataType: "json",//预期服务器返回的数据类型
			                url: "${ctx}/role/saveOrUpdate.do" ,//url
			                data: field,
			                success: function (data) {
			                    console.log(data);//打印服务端返回的数据(调试用)
			                    if (data.code == 0) {
		    ...
		    table.on("tool(LAY-user-back-role)", function(e) {
				...
				if ("del" === e.event) 
					...
					layer.open({
						type : 2,
						title : "编辑角色",
						content : "${ctx}/role/roleEdit.do?id="+e.data.id,
						maxmin : !0,
						area : ['800px', '480px'],
						btn : [ "确定", "取消" ],
						yes : function(e, t) {
							var l = window["layui-layer-iframe" + e],
								r = "LAY-user-role-submit",
