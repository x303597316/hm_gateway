...
<body>
            ...
            <div class="test-table-reload-btn" style="margin-bottom: 10px;">
				<div class="layui-form-item" style="margin: 0;">
					...
					<div class="layui-input-inline" >
						<input class="layui-input"  id="contentname" type="text" placeholder="请输入标题" />
					</div>
					...
					<div class="layui-input-inline">
	            		...
	            		<option value="2" >定期报告</option>
	            		<option value="3" >公告</option>
	            		<option value="4" >制度</option>
				        </select>
					</div>
  ...
  layui.config({
    ...
    table.render({
      ...
      ,url: '${ctx}/investor/investorList.do'
      ,cols: [[
        {checkbox: true}
        ,{field:'id', title: 'ID', width:'3%', sort: true} 
        ,{field:'contentname', title: '标题', width:'8%'}
        ,{field:'type', title: '类型', width:'10%'}
        ,{field:'details', title: '详情',  width:'50%'}
      ...
      ,done: function(res, page, count) {
    	  ...
    	  $("[data-field='type']").children().each(function() {
			if ($(this).text() == 1) {
				...
				$(this).html("<span class='layui-btn layui-btn-success layui-btn-normal layui-btn-xs'>定期报告</span>")
			} else if ($(this).text() == 3) {
				$(this).html("<span class='layui-btn layui-btn-success layui-btn-normal layui-btn-xs'>公告</span>")
			} else if ($(this).text() == 4) {
				$(this).html("<span class='layui-btn layui-btn-success layui-btn-normal layui-btn-xs'>制度</span>")
			} 
		});
          ...
          ,yes: function(index, layero){
            ...
            iframeWindow.layui.form.on('submit('+ submitID +')', function(data){
              ...
              $.ajax({
	                ...
	                url: "${ctx}/investor/addorUpdate.do" ,//url
	                data:field,
    ...
    table.on("tool(test-table-reload)", function(e) {
		...
		if ("edit" === e.event) { 
			var topicEdit = layer.open({
				type : 2,
				title : "文档编辑",
				content : "${ctx}/investor/edit.do?id="+e.data.id
				,maxmin: true
		          ,area: ['50%', '100%']
		          ,btn: ['提交','取消']
		          ,yes: function(index, layero){
			...
			layer.confirm('确定删除吗？', function(index) {
	            ...
	            $.ajax({
	                type: "POST",//方法类型
	                dataType: "json",//预期服务器返回的数据类型
	                url: "${ctx}/investor/drop.do?id="+e.data.id,//url
