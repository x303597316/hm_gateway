...
<body class="beg-login-bg">
   ...
   <!-- <div style="margin-top: 30px;margin-left: 30px;">
	...
	<div class="beg-login-box">
		<header>
			<div style="line-height: 38px;"><img alt="" src="./static/images/title.png" style="width: 80%;margin-left: 10%;"></div>
		</header>
		<div class="beg-login-main">
			<form action="login.do" class="layui-form" method="post" id="loginForm">
				...
				<div class="layui-form-item">
					...
					<div class="beg-pull-right">
						<button class="layui-btn layui-btn-primary" lay-submit
							lay-filter="login.do" style="background-color: #c8142d;color: white;">
							登录
						</button>
					</div>
