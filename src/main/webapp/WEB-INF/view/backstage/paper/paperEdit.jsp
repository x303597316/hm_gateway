    ...
    <div class="layui-card">
      ...
      <div class="layui-card-body" style="padding: 15px;">
        <form class="layui-form" action="" lay-filter="component-form-group">
          ...
          <div class="layui-form-item">
            ...
            <div class="layui-input-block">
            	<select  lay-verify="required" lay-filter="newsType" lay-search="" >
            		...
            		<option value="1"  <c:if test="${entity.type eq '1' }">selected</c:if> >资料下载</option>
            		<option value="2"  <c:if test="${entity.type eq '2' }">selected</c:if> >软件下载</option>
            		<option value="3"  <c:if test="${entity.type eq '3' }">selected</c:if> >常见问题</option>
            	</select>
            </div>
          </div>
          <div class="layui-form-item">
            ...
            <div class="layui-input-block">
              <input type="text" name="updatetime" lay-verify="required" id="LAY-component-form-group-date" value="${entity.updatetime }" placeholder="yyyy-MM-dd" autocomplete="off" class="layui-input">
            </div>
          </div>
         ...
         <div class="layui-form-item" id="myeditor">
          <label class="layui-form-label">页面内容</label>
            <div class="layui-input-block">
	            <blockquote class="site-text layui-elem-quote">
			      <p>提示：<em>富文本编辑器中请不要单独添加一个视频作为内容，请附加文本后再提交，否则不能保存信息</em></p>
			    </blockquote>
          		<TEXTAREA id="myEditor" style="width:99.8%;height:700px;margin:auto;" >${entity.parperContent}</TEXTAREA>  
          	</div>
          </div>
